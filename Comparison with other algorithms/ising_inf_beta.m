%This function implements the discrete-time version of label propagation.
...
function [duration, error, iterations] = ising(A, V1, V2, n, alpha, eta, lambda, target_error, max_iter)
tic
